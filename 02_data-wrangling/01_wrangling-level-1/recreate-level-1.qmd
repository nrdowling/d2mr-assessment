...
#Problem with getting original working directory to work so will create getwd() and setwd() then place it
getwd()
setwd("/Users/michaelavalosjr./Downloads/Rstudio/d2mr-assessment-avalosmajr/02_data-wrangling/01_wrangling-level-1")

sw.wrangled.goal <- read_csv("/Users/michaelavalosjr./Downloads/Rstudio/d2mr-assessment-avalosmajr/02_data-wrangling/01_wrangling-level-1/sw-wrangled.csv") %>% 
